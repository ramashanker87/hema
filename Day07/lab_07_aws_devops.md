...
```bash
chmod 400 <KEY-FILE>
ssh -i hema-ec2 ec2-user@18.232.90.38
jenkins-hema-app-deploy
ssh -i hema-ec2 ec2-user@18.234.239.112
hema-jenkins-server
ssh -i hema-ec2 ec2-user@98.93.68.0
```

Example:

```bash
chmod 400 hema-key-pair-name.pem

ssh -i hema-key-pair-name.pem ec2-user@18.232.90.38

ssh -i hema-key.pem ec2-user@54.210.241.149
```
...
```bash
ssh -i hema-key.pem ec2-user@52.91.140.111
```
