...
# STEP 1 – Create CodeCommit Repository
    ...
    - Repository name: devops-training-repo
     ...
     aws codecommit create-repository \
      --repository-name devops-training-repo-hema \
...
# STEP 2 – Clone Repository
    ...
    git clone https://git-codecommit.us-east-1.amazonaws.com/v1/repos/devops-training-repo-hema
    cd devops-training-repo-hema
...
#  STEP 5 – Create S3 Bucket
    ...
    - devops-training-build-artifacts-hema

---


#  STEP 7 – CodeBuild Project
    project name: devops-build-hema
    Source: CodeCommit
    repository: devops-training-repo-hema
    Branch: master
    ...
    Artifacts :S3
    Bucket Name: devops-training-build-artifacts-hema
    Name: output
    Path: (empty)
