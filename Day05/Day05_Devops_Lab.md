...
```bash
blue-green
ssh -i hema-ec2.pem ec2-user@184.72.90.6
blue-1
ssh -i hema-ec2.pem ec2-user@52.91.37.51
blue-2
ssh -i hema-ec2.pem ec2-user@34.202.166.86
green-1
ssh -i hema-ec2.pem ec2-user@34.229.75.169
green-2
ssh -i hema-ec2.pem ec2-user@54.227.184.191
```
